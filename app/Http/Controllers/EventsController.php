...
class EventsController extends BaseController
{
    ...
    public function getEventsWithWorkshops() {
        ...
        //get all events with related worskshops

        return $events = Event::with('workshops')->get();
    ...
    public function getFutureEventsWithWorkshops() {
        ...
        //get all future events with related worskshops
        return $events = Event::with('workshops')->whereHas('workshops', function ($query) {
